    ...
    class _Question_Picker
    {
        ...
        private static void setQs()
        {
            ...
            { 
                ...
                "1_2: Create two interfaces each with a method that take two parameters and a class that implements and uses both of these methods in the same instance",
                ...
                "6_4: Create a fn that reads from a StringReader with a try and finally block",
                },
                new List<string>()
                {
                ...
                new List<string>()
                {
                "8_0: Create a class that has two variables, and sort an array of that class using one of them, with OrderBy",
                "8_1: Create a List of Book Titles {string name}, and then write a query to get the ones that has \"Tutorials\" in them",
                "8_2: Create a List of Students {int age, string name}, and then write a query to get the ones that are teenagers",
                ...
                new List<string>()
                {
                "11_0: Create a class that implements a generic list with Add (aka push), and another class that implements it",
                "11_1: Create a generic list where the nodes of the list can have any kind of data type",
                "11_2: Create a fn that creates a query with",
                "11_3: Create a fn that creates a query with",
                "11_4: Create a fn that creates a query with",
                },
            };

            // LinQ: Array methods Where, OrderBy, Select, ToArray
            // Generics
            // Speed of API over DoubleCF
            // Delegates
            // IEnumerable
            // Anonomous Fns https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/statements-expressions-operators/anonymous-functions
            // Lambda functions
            // Lambda expressions
            // Virtual classes
            // try and finally
            // Using '?' to keep null values from causing errors
            // C# Closures
