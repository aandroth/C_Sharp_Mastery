    ...
    class _Question_Picker
    {
        ...
        private static void setQs()
        {
            ...
            string[,] temp = new string[,]
            {
                ...
                "4_1: Create and use an abstract class, Undead with a variable and fn, which is then used by the classes Skeleton, Ghost, and Lich.",
                "4_2: Define an abstract class, and its closest match to a class in C++",
                ...
                "5_1: List out the differences between structs and classes",
                "5_2: Create an abstract struct and a virtual struct. Implement both.",
                "5_3: Create a sealed, read-only struct.",
                "5_4: Create a struct that can mutate its variable.",
                },
            };
